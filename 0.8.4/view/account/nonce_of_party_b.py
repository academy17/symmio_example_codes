...
def main():
    try:
        nonce = contract.functions.nonceOfPartyB(PARTY_B, PARTY_A).call()
        print(f"Nonce of Party B {PARTY_B} with Party A {PARTY_A}: {nonce}")
    except Exception as e:
        print("Error calling nonceOfPartyB:", e)
