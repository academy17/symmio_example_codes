...
def main():
    try:
        allocated_balance = contract.functions.allocatedBalanceOfPartyB(PARTY_B, PARTY_A).call()
        print(f"Allocated balance of Party B {PARTY_B} with Party A {PARTY_A}: {allocated_balance}")
    except Exception as e:
        print("Error calling allocatedBalanceOfPartyB:", e)
