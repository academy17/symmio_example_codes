...
def main():
    try:
        open_positions = contract.functions.getPartyBOpenPositions(PARTY_B, PARTY_A, START, SIZE).call()
        print(f"Open positions for Party B {PARTY_B} and Party A {PARTY_A}:", open_positions)
    except Exception as e:
        print("Error calling getPartyBOpenPositions:", e)
