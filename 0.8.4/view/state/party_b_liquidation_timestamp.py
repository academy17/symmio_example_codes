...
def main():
    try:
        timestamp = contract.functions.partyBLiquidationTimestamp(PARTY_B, PARTY_A).call()
        print(f"Party B liquidation timestamp for Party B {PARTY_B} and Party A {PARTY_A}: {timestamp}")
    except Exception as e:
        print("Error calling partyBLiquidationTimestamp:", e)
