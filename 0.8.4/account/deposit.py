...
AMOUNT = w3.to_wei(500, "ether")  # Adjust decimals as needed
...
def main():
    try:
        ...
        # 2. Deposit
        deposit_txn = diamond.functions.deposit(AMOUNT).build_transaction({
            "from": account.address,
            "nonce": w3.eth.get_transaction_count(account.address),
            "gas": 200000,
            "gasPrice": w3.eth.gas_price,
        ...
        print(f"Deposit transaction sent! Tx hash: {deposit_tx_hash.hex()}")
