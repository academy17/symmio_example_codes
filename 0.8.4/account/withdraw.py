...
def main():
    try:
        withdraw_txn = diamond.functions.withdraw(AMOUNT).build_transaction({
        ...
        print(f"Withdraw transaction sent! Tx hash: {withdraw_tx_hash.hex()}")
    except Exception as e:
        print("Error sending withdraw transaction:", e)
