...
def main() -> None:
	...
	if (
		...
		raise SystemExit(
			"Missing env vars: RPC_URL, PRIVATE_KEY, DIAMOND_ADDRESS (or SYMMIO_DIAMOND_ADDRESS), SENDER, RECEIVER, TRADE_ID"
		)
	...
	# transferTradeFromNFT(sender, receiver, tradeId)
	tx = diamond.functions.transferTradeFromNFT(
	...
	print(f"transferTradeFromNFT tx sent: {h.hex()}")
