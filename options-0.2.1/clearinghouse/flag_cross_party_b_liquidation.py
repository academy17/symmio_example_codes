...
def main() -> None:
	...
	# flagCrossPartyBLiquidation(partyB, partyA, collateral) - requires CLEARING_HOUSE_ROLE
	tx = diamond.functions.flagCrossPartyBLiquidation(
	...
	print(f"flagCrossPartyBLiquidation tx sent: {h.hex()}")
