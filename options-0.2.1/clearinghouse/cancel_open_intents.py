...
def main() -> None:
	...
	# cancelOpenIntents(intentIds) - requires CLEARING_HOUSE_ROLE
	tx = diamond.functions.cancelOpenIntents(intent_ids).build_transaction(
		{
			"from": acct.address,
	...
	print(f"cancelOpenIntents tx sent: {h.hex()}")
