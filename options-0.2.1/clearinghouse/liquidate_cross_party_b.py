...
def main() -> None:
	...
	if (
		...
		raise SystemExit(
			"Missing env vars: RPC_URL, PRIVATE_KEY, DIAMOND_ADDRESS, PARTY_B_ADDRESS, PARTY_A_ADDRESS, COLLATERAL_ADDRESS, UPNL, COLLATERAL_PRICE"
		)
	...
	# liquidateCrossPartyB(partyB, partyA, collateral, upnl, collateralPrice) - requires CLEARING_HOUSE_ROLE
	tx = diamond.functions.liquidateCrossPartyB(
	...
	print(f"liquidateCrossPartyB tx sent: {h.hex()}")
