...
def main() -> None:
	...
	# flagIsolatedPartyBLiquidation(partyB, collateral) - requires CLEARING_HOUSE_ROLE
	tx = diamond.functions.flagIsolatedPartyBLiquidation(
	...
	print(f"flagIsolatedPartyBLiquidation tx sent: {h.hex()}")
