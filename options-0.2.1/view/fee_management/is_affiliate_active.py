...
def main():
    try:
        affiliate_active = contract.functions.isAffiliateActive(AFFILIATE_ADDRESS).call()
        print(f"Is affiliate active {AFFILIATE_ADDRESS}: {affiliate_active}")
    except Exception as e:
        print("Error calling isAffiliateActive:", e)
