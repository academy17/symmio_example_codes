...
def main():
    try:
        party_b_config = contract.functions.getPartyBConfig(PARTY_B_ADDRESS).call()
        print(f"Party B config for {PARTY_B_ADDRESS}: {party_b_config}")
    except Exception as e:
        print("Error calling getPartyBConfig:", e)
