...
def main():
    try:
        reserve_balance = contract.functions.getReserveBalance(USER_ADDRESS, COLLATERAL_ADDRESS).call()
        print(f"Reserve balance of {USER_ADDRESS} for collateral {COLLATERAL_ADDRESS}: {reserve_balance}")
    except Exception as e:
        print("Error calling getReserveBalance:", e)
