...
def main():
    try:
        isolated_balance = contract.functions.getIsolatedBalance(USER_ADDRESS, COLLATERAL_ADDRESS).call()
        print(f"Isolated balance of {USER_ADDRESS} for collateral {COLLATERAL_ADDRESS}: {isolated_balance}")
    except Exception as e:
        print("Error calling getIsolatedBalance:", e)
