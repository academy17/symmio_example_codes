...
def main() -> None:
	...
	# deallocateFromReserveBalance(collateral, amount)
	tx = diamond.functions.deallocateFromReserveBalance(
	...
	print(f"deallocateFromReserveBalance tx sent: {tx_hash.hex()}")
