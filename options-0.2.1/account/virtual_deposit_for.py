...
def main() -> None:
	...
	# virtualDepositFor(collateral, user, amount) - requires VIRTUAL_DEPOSITOR_ROLE
	tx = diamond.functions.virtualDepositFor(
	...
	print(f"virtualDepositFor tx sent: {tx_hash.hex()}")
